...
### `max_email_bytes`
Максимальный размер одного письма в байтах. Если все книги не помещаются в одно письмо, бот разобьёт их отправку на несколько писем.
