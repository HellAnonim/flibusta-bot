...
### `webdav`
Старый блок настроек источника INPX/файлов. Может оставаться в рабочем конфиге для совместимости со старой схемой.

- `webdav.base_url` — базовый URL источника
- `webdav.username` — логин
- `webdav.password` — пароль

### `archive_webdav`
Старый дополнительный блок для доступа к архивам книг.

- `archive_webdav.username` — логин
- `archive_webdav.password` — пароль
